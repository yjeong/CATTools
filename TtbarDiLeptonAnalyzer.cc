...
private:
  ...
  bool b_step0,b_step1, b_step2, b_step3, b_step4, b_step5, b_step6, b_step7, b_filtered;
...
void TtbarDiLeptonAnalyzer::setBranch(TTree* tr, systematic sys)
{
  ...
  tr->Branch("step0", &b_step0, "step0/O");
...
void TtbarDiLeptonAnalyzer::resetBranch()
{
  ...
  b_step0 = 0;b_step1 = 0;b_step2 = 0;b_step3 = 0;b_step4 = 0;b_step5 = 0;b_step6 = 0;b_step7 = 0;b_tri = 0;b_filtered = 0;
  b_met = -9;
