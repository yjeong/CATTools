...
process.load("CATTools.CatProducer.mcTruthTop.partonTop_cfi")#except when running SingleTop, and SingleTbar-->reason: using the two 'Top' this line has not used
